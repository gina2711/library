        ...
        <div class="col-lg-12" style="min-height:600px;">
          <div class="card mt-3">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col">
                  <form action="pinjam_tambah_aksi.php" method="GET">
                    <!-- isi field tabel -->
                  <div class="form-group">
                    <label for="">Kode Pinjam</label>
                    <input type="text" class="form-control" placeholder="Masukan ID pinjam" name="kd_pinjam">
                  </div>
                  <div class="form-group">
                    ...
                    <select class="custom-select my-1 mr-sm-2" name="kd_buku" id="">
                      ...
                      ?>     
                          <option value="<?php echo $buku_data['kd_buku']?>">
                              <?php echo /*$buku_data['kd_buku'],"-",*/ $buku_data['kd_buku']?>
                          </option>    
                      <?php
                          }
                      ?>
                    ...
                    <select class="custom-select my-1 mr-sm-2" name="id_pustakawan" id="">
                      ...
                      ?>     
                          <option value="<?php echo $pustakawan_data['id_pustakawan']?>">
                              <?php echo /*$pustakawan_data['id_pustakawan'],"-",*/ $pustakawan_data['id_pustakawan']?>
                          </option>    
                      <?php
                          }
                      ?>
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" placeholder="Tanggal Peminjaman Buku" name="tgl_pinjam">
                  </div>
                  <div class="form-group">

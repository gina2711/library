<?php
    include "../../header.php";
    $tampil = "select * from pengembalian";
        ...
        <div class="col-lg-12" style="min-height:600px;">
          <div class="card mt-3">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col">
                <a href="kembali_tambah.php" class="btn btn-primary">Tambah Data</a>
                </div>
                <div class="col">
              ...
              <div class="col">
                ...
                <?php
                    if(isset($_GET['cari'])){
                        ...
                        $hasil=mysqli_query($koneksi,"select * from peminjaman where kd_kembali like '$keyword'
                        or kd_pinjam '$keyword'
                        or nis like '$keyword'
                ...
                <td> <?php echo $ambil_data['kd_kembali'];?></td>
                ...
                <td class="text-center"> <a href="kembali_ubah.php?id=<?php echo $ambil_data['kd_kembali'];?>" class="btn btn-warning">Ubah</a></td>
                <td class="text-center"> <a href="kembali_hapus.php?id=<?php echo $ambil_data['kd_kembali'];?>" onclick="return confirm('Apa Anda yakin akan menghapus Data kembali ?')" class="btn btn-danger">Hapus</a> </td>
                </tr>
                <?php
                    }
                ?>
            ...
            <div class="row text-center"> 
                  <div class="col">
                  <a href="kembali_cetak.php" class="btn btn-secondary">Cetak Data</a>
                  </div>
                </div> 
            </div>
          </div>
